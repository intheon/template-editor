...
{
	if (newNumberOfButtons == 0) $('#ButtonLatest').hide();
		else $('#ButtonLatest').show();
		
	if (newNumberOfButtons <= 1) $('#ButtonAll').hide();
		else $('#ButtonAll').show();

	if (newNumberOfButtons <= 2) $('#ButtonRegister').hide();
		else $('#ButtonRegister').show();
}
